...
ggsave("visualization/imgs/static_heatmap_default_demo.png", width = 7, height = 8, dpi = 100)

static.pie.default.battles()
ggsave("visualization/imgs/static_pie_default_battles_demo.png", width = 7, height = 6.5, dpi = 100)

trend.nations.battles(class.sample = "Ground_vehicles", y = "rb_battles_sum")
ggsave("visualization/imgs/trend_nations_battles_demo.png", width = 7, height = 8, dpi = 100)
...
ggsave("visualization/imgs/static_scatter_demo.png", width = 7, height = 8, dpi = 100)
...
ggsave("visualization/imgs/static_bars_demo.png", width = 7, height = 8, dpi = 100)
...
animation.trend.heatmap(class.sample = "Ground_vehicles", fill = "rb_win_rate",
  ...
  animation.render(width = 7, height = 8, dpi = 100, fps = 10)
