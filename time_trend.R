...
trend.nations <- function(class.sample = "Ground_vehicles", y = "rb_win_rate", rb_br.sample = "1.0 ~ 10.3") {
...
trend.nations.battles <- function(class.sample = "Ground_vehicles", y = "rb_battles_sum", rb_br.sample = "1.0 ~ 10.3") {
  # read the data generated by function cache_br_flat_df in integration/concator.py
  data <- read.csv(cache.file.path) %>% as.data.table
